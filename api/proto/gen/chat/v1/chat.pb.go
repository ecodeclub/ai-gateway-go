...
func (x *StreamRequest) GetChatSn() string {
	if x != nil {
		return x.ChatSn
	}
	return ""
...
func (x *StreamRequest) GetInput() *UserInput {
	if x != nil {
		return x.Input
	}
	return nil
...
type StreamResponse struct {
	...
	//
	//	*StreamResponse_Delta
	//	*StreamResponse_Attachments
	//	*StreamResponse_Error
	//	*StreamResponse_StepUpdate
	//	*StreamResponse_Usage
...
func (x *StreamResponse) GetDelta() *Delta {
	if x != nil {
		if x, ok := x.Event.(*StreamResponse_Delta); ok {
			return x.Delta
		}
	}
	return nil
...
func (x *StreamResponse) GetAttachments() *Attachments {
	if x != nil {
		if x, ok := x.Event.(*StreamResponse_Attachments); ok {
...
func (x *StreamResponse) GetError() *Error {
	if x != nil {
		if x, ok := x.Event.(*StreamResponse_Error); ok {
			return x.Error
		}
	}
	return nil
...
func (x *StreamResponse) GetStepUpdate() *StepUpdate {
	if x != nil {
		if x, ok := x.Event.(*StreamResponse_StepUpdate); ok {
			return x.StepUpdate
		}
	}
	return nil
...
func (x *StreamResponse) GetUsage() *Usage {
	if x != nil {
		if x, ok := x.Event.(*StreamResponse_Usage); ok {
			return x.Usage
		}
	}
	return nil
...
type StreamResponse_Delta struct {
	Delta *Delta `protobuf:"bytes,1,opt,name=delta,proto3,oneof"`
}

type StreamResponse_Attachments struct {
...
type StreamResponse_StepUpdate struct {
	// 执行到了什么步骤的信息
	StepUpdate *StepUpdate `protobuf:"bytes,4,opt,name=step_update,json=stepUpdate,proto3,oneof"`
}

type StreamResponse_Usage struct {
	Usage *Usage `protobuf:"bytes,5,opt,name=usage,proto3,oneof"`
}

func (*StreamResponse_Delta) isStreamResponse_Event() {}

func (*StreamResponse_Attachments) isStreamResponse_Event() {}

func (*StreamResponse_Error) isStreamResponse_Event() {}

func (*StreamResponse_StepUpdate) isStreamResponse_Event() {}

func (*StreamResponse_Usage) isStreamResponse_Event() {}
...
func (x *SaveRequest) GetBizId() int64 {
	if x != nil {
		return x.BizId
	}
	return 0
...
const file_chat_v1_chat_proto_rawDesc = "" +
	...
	"\vSaveRequest\x12!\n" +
	"\x04chat\x18\x01 \x01(\v2\r.chat.v1.ChatR\x04chat\x12\x15\n" +
	"\x06biz_id\x18\x02 \x01(\x03R\x05bizId\"\x1e\n" +
	...
	"\x11reasoning_content\x18\x04 \x01(\tR\x10reasoningContent2\xeb\x01\n" +
	"\aService\x123\n" +
	...
	"\x06Stream\x12\x16.chat.v1.StreamRequest\x1a\x17.chat.v1.StreamResponse0\x01B\x96\x01\n" +
	"\vcom.chat.v1B\tChatProtoP\x01Z?github.com/ecodeclub/ai-gateway-go/api/proto/gen/chat/v1;chatv1\xa2\x02\x03CXX\xaa\x02\aChat.V1\xca\x02\aChat\\V1\xe2\x02\x13Chat\\V1\\GPBMetadata\xea\x02\bChat::V1b\x06proto3"
...
var file_chat_v1_chat_proto_goTypes = []any{
	...
	(*Usage)(nil),          // 2: chat.v1.Usage
	(*UserInput)(nil),      // 3: chat.v1.UserInput
	(*Error)(nil),          // 4: chat.v1.Error
	(*StepUpdate)(nil),     // 5: chat.v1.StepUpdate
	(*Attachments)(nil),    // 6: chat.v1.Attachments
	(*Delta)(nil),          // 7: chat.v1.Delta
	(*SaveRequest)(nil),    // 8: chat.v1.SaveRequest
	(*SaveResponse)(nil),   // 9: chat.v1.SaveResponse
	(*DetailRequest)(nil),  // 10: chat.v1.DetailRequest
	(*DetailResponse)(nil), // 11: chat.v1.DetailResponse
	(*Chat)(nil),           // 12: chat.v1.Chat
	(*ListRequest)(nil),    // 13: chat.v1.ListRequest
	(*ListResponse)(nil),   // 14: chat.v1.ListResponse
	(*Message)(nil),        // 15: chat.v1.Message
	nil,                    // 16: chat.v1.Attachments.EntriesEntry
}
var file_chat_v1_chat_proto_depIdxs = []int32{
	3,  // 0: chat.v1.StreamRequest.input:type_name -> chat.v1.UserInput
	7,  // 1: chat.v1.StreamResponse.delta:type_name -> chat.v1.Delta
	6,  // 2: chat.v1.StreamResponse.attachments:type_name -> chat.v1.Attachments
	4,  // 3: chat.v1.StreamResponse.error:type_name -> chat.v1.Error
	5,  // 4: chat.v1.StreamResponse.step_update:type_name -> chat.v1.StepUpdate
	2,  // 5: chat.v1.StreamResponse.usage:type_name -> chat.v1.Usage
	16, // 6: chat.v1.Attachments.entries:type_name -> chat.v1.Attachments.EntriesEntry
	12, // 7: chat.v1.SaveRequest.chat:type_name -> chat.v1.Chat
	12, // 8: chat.v1.DetailResponse.chat:type_name -> chat.v1.Chat
	15, // 9: chat.v1.Chat.msgs:type_name -> chat.v1.Message
	12, // 10: chat.v1.ListResponse.chats:type_name -> chat.v1.Chat
	13, // 11: chat.v1.Service.List:input_type -> chat.v1.ListRequest
	10, // 12: chat.v1.Service.Detail:input_type -> chat.v1.DetailRequest
	8,  // 13: chat.v1.Service.Save:input_type -> chat.v1.SaveRequest
	0,  // 14: chat.v1.Service.Stream:input_type -> chat.v1.StreamRequest
	14, // 15: chat.v1.Service.List:output_type -> chat.v1.ListResponse
	11, // 16: chat.v1.Service.Detail:output_type -> chat.v1.DetailResponse
	9,  // 17: chat.v1.Service.Save:output_type -> chat.v1.SaveResponse
	1,  // 18: chat.v1.Service.Stream:output_type -> chat.v1.StreamResponse
...
func file_chat_v1_chat_proto_init() {
	...
	file_chat_v1_chat_proto_msgTypes[1].OneofWrappers = []any{
		(*StreamResponse_Delta)(nil),
		(*StreamResponse_Attachments)(nil),
		(*StreamResponse_Error)(nil),
		(*StreamResponse_StepUpdate)(nil),
		(*StreamResponse_Usage)(nil),
	}
	type x struct{}
