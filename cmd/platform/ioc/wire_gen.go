...
func InitApp() *App {
	...
	bizService := service.NewBizConfigService(bizConfigRepository)
	chatServer := grpc.NewChatServer(chatService, orchestratorOrchestrator, bizService)
	...
	bizConfigHandler := admin.NewBizConfigHandler(bizService)
