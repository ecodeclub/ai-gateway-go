...
// Source: internal/service/biz_config.go
//
// Generated by this command:
//
//	mockgen -source=internal/service/biz_config.go -destination=internal/service/mocks/bizconfig_mock.go -package=mocks
//
...
func (mr *MockBizConfigServiceMockRecorder) GetByID(ctx, id any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Detail", reflect.TypeOf((*MockBizConfigService)(nil).GetByID), ctx, id)
}
